import Ada, { CertificateType,  Networks, PoolKeyType, PoolOwnerType, PoolRewardAccountType, TransactionSigningMode, TxOutputDestinationType } from '..';
        ...
        const response = await app.signTransaction({
          tx: {
            ...
            inputs: [
              {
                path: null,
                txHashHex: 'a2218c7738c374fa68fed428bf28447f550c3c33cb92a5bd06e2b62f37779539',
                outputIndex: 0,
              },
              {
                path: null,
                txHashHex: 'ade4616f96066ab24f49dcd4adbcae9ae83750d34e4620a49d737d4a66835d64',
                outputIndex: 0,
              },
            ],
            outputs: [
              {
                ...
                destination: {
                  type: TxOutputDestinationType.THIRD_PARTY,
                  params: {
                    addressHex: '01bf63a166d9c10d85e4fd3401de03907e232e7707218c3bfd5a570d7acab53e9efebb49bafb4e74d675c2d682dd8e402f15885fb6d1bc0023',
                  },
                },
                amount: 9810000,
                tokenBundle: [
                  {
                    policyIdHex: '0b1bda00e69de8d554eeafe22b04541fbb2ff89a61d12049f55ba688',
                    tokens: [{
              ...
              },
              {
                ...
                destination: {
                  type: TxOutputDestinationType.THIRD_PARTY,
                  params: {
                    addressHex: '0114c16d7f43243bd81478e68b9db53a8528fd4fb1078d58d54a7f11241d227aefa4b773149170885aadba30aab3127cc611ddbc4999def61c',
                  },
                },
                amount: 3491695,
              },
