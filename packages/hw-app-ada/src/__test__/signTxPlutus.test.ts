          ...
          inputs: [
            {
              path: null,
              txHashHex:
                'd44c3a039c9f4c4a117f91f7475974f64e51a3bfbc7729132f2ef0b025f76e06',
              outputIndex: 1,
            },
          ],
          outputs: [
            {
              ...
              destination: {
                ...
                params: {
                  addressHex:
                    '70dfcad2d5ae0c192e2dbcc1fab7783d13f862a06fbc59bfc73244576b',
                },
              },
              amount: 10000000,
              datum: {
            ...
            },
            {
              ...
              amount: 5000000,
              referenceScriptHex:
                '820258425840010000332233322222253353004333573466ebc00c00801801440204c98d4c01ccd5ce2481094e6f7420457175616c0000849848800848800480044800480041',
            },
            {
              format: 1,
              destination: {
    ...
    it('Should successfully sign plutus transaction with required signers', async () => {
      const response = await app.signTransaction({
        tx: {
          ...
          inputs: [
            {
              path: null,
              txHashHex:
                '1789f11f03143338cfcc0dbf3a93ad8f177e8698fc37ab3ab17c954cf2b28ee8',
              outputIndex: 0,
            },
          ],
          outputs: [
            {
              ...
              destination: {
                ...
                params: {
                  addressHex:
                    '00ed9c04b17347c86bfa474bed975a01241f2ce091fb82255e16bfa884f9c4b2e3208664aa773a6b64f92bf8ec0f64b1365029632efd2ef939',
                },
              },
              amount: 989817867,
            },
          ...
          fee: 182133,
          scriptDataHashHex:
            '13a83818f68bb170dff0ab8a8c0098c5a14db0e43e04c9661dd3f64deb8241c2',
          collateralInputs: [
            {
              path: null,
              txHashHex:
