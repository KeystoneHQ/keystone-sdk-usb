import Ada, { CertificateType, CredentialParamsType, Networks, TransactionSigningMode, TxOutputDestinationType } from '..';
    ...
    it('Should successfully sign transaction with stake delegation', async () => {
        const response = await app.signTransaction({
          tx: {
            ...
            inputs: [{
              path: null,
              txHashHex: '71b1f4d93070d035b27ce482784617238f75342d7d2da77a97828c9f561bff38',
              outputIndex: 0,
            }],
            outputs: [{
              format: 0,
            ...
            certificates: [{
              ...
              params: {
                poolKeyHashHex: '04c60c78417132a195cbb74975346462410f72612952a7c4ade7e438',
                stakeCredential: {
    ...
    it('Should successfully sign transaction with withdrawals', async () => {
        const response = await app.signTransaction({
          tx: {
            ...
            inputs: [{
              path: null,
              txHashHex: 'bc8bf52ea894fb8e442fe3eea628be87d0c9a37baef185b70eb00a5c8a849d3b',
              outputIndex: 0,
            }],
            outputs: [{
              format: 0,
    ...
    it('Should successfully sign transaction with tokens', async () => {
        const response = await app.signTransaction({
          tx: {
            ...
            inputs: [{
              path: null,
              txHashHex: '14fee2d6da11448c33c63d3f33eaafa33fbb55523a8e7a59f3454d4ff143f5f6',
              outputIndex: 0,
            }],
            outputs: [{
              format: 0,
