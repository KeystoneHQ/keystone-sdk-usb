import { parseEApduPacket, generateEApduPackets } from '../src/frame';
import { safeJSONparse } from '../src/helper';
...
test('EAPDU packet generation', () => {
  ...
  const packets = generateEApduPackets(command, requestID, strData);
