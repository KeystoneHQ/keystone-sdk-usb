...
export type SpendingDataSourceNone = {
  type: SpendingDataSourceType.NONE;
};
export type SpendingDataSourcePath = {
  type: SpendingDataSourceType.PATH;
  path: ValidBIP32Path;
};
export type SpendingDataSourceScriptHash = {
...
export type StakingDataSourceNone = {
  type: StakingDataSourceType.NONE;
};
export type StakingDataSourcePath = {
  type: StakingDataSourceType.KEY_PATH;
  path: ValidBIP32Path;
};
export type StakingDataSourceKeyHash = {
...
export type StakingDataSourceScriptHash = {
